...
export function ProjectArt({ seed }: { seed: string }) {
  ...
  // are generous and centres can sit outside the frame, which is what keeps the composition from
  // looking like three circles in a box.
  ...
  return (
    ...
    >
      ...
      <rect width="100" height="100" fill="#0b0b0e" opacity="0.18" />
    </svg>
  );
}
